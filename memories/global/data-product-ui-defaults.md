...
When building or reviewing a data-driven product UI, apply these defaults. They generalize the corrections the user re-filed repeatedly on the your-data-product dashboard; they are how she expects ANY data product to behave.
