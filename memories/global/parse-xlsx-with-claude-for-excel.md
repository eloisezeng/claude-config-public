...
When parsing your `.xlsx` files — e.g. `resources/jordan/2_your_data_product_agent_schedule.xlsx` — use the **Claude for Excel add-in** rather than a stdlib `zipfile`/XML fallback parser.
...
**How to apply:** reach for the Claude for Excel add-in first for any spreadsheet analysis. See [[a-project-plan]] for the broader Alex/Jordan-feedback context this came up in.
