...
description: On your Mac, `find` is bfs, which rejects `-newermt '-20 minutes'` (relative dates) — a freshness probe with swallowed stderr then matches NOTHING, ever
scope: global
metadata:
  type: reference
---

On your Mac, `find` resolves to **bfs**, not BSD/GNU find.
