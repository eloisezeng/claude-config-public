...
| your-review-tool-threading-and-collapsibles | claude/your-other-project | move | f416176ba5 | 2bdfe366 |
| your-review-tool-no-redisplay-answered-questions | claude/your-other-project | move | deb33fb400 | 55767a6f |
...
| brainstorm-in-your-review-tool | claude1/your-project | move | 79796af03c | 09853060 |
...
| your-review-tool-artifact-prefs | claude1/your-project | move | c8eab06799 | 4e85aedd |
| your-review-tool-fork | claude1/your-project | move | a9b64f74a0 | 39a21c8a |
...
| use-your-review-tool-for-visualization | claude/your-other-project | merge→visualize-in-browser | 8e7ec3c891 | 699b70ec |
| visualize-means-your-review-tool | claude/your-other-project | merge→visualize-in-browser | 8ea902d44e | 699b70ec |
| notify-only-on-convergence-or-blocked | claude/your-other-project | merge→notify-on-response | 431d212830 | 55767a6f |
| your-review-tool-fork-sse-hardening | claude/your-other-project | downgrade (local to your-review-tool-fork work) | 344b5890d2 | 64260f39 |
...
- **merge→visualize-in-browser:** `use-your-review-tool-for-visualization` + `visualize-means-your-review-tool` both say "visualize = build your-review-tool artifact" — the same rule, twice.
...
- **downgrade your-review-tool-fork-sse-hardening:** this is implementation work on a specific your-review-tool-fork feature branch (SSE hardening, Slack thread panel) — project-specific to your-review-tool-fork repo, not a universal preference. Stays local.
