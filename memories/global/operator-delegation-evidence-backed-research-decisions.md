...
Requirements when exercising it: write the decision record (ADR/log) BEFORE acting, cite the measurements, and notify you afterward in the consolidated summary.
...
**Why:** granted 2026-08-06 during your-research-project round-3 launch after four consecutive AskUserQuestion rounds (ifc_heat promotion, weak-gap handling, pfc regeneration, option-A context) in which you picked the "(recommended)" option every time and then asked "why did u need my approval? couldn't u have guessed?".
...
Interruptions cost you more than the delegation risks, BECAUSE the decision-record + measurement discipline keeps every call auditable and reversible.
