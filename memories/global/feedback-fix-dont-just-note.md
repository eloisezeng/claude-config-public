...
Two standing work preferences from you:
...
**Why:** noting-without-fixing leaves rot; you'd rather pay the extra edit now. Convergence (two independent reviewers iterating to agreement) catches more than a single pass. Matches [[execution-verification-prefs]].
